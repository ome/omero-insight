...
public class IconManager {
     ...
     * The pathname, relative to this class, of the login splash screen.
     */
    private static final String IMAGEJ_SPLASHSCREEN = "omeroImageJSplashscreen.png";

    /**
     * The pathname, relative to this class, of the OME screen.
     */
    private static final String OME_ICON = "omero16.png";
     ...
     * @return See above.
     */
    public static ImageIcon getLoginBackground() {
        return IconFactory.getIcon(LOGIN_BACKGROUND);
    }
     ...
     * @return See above.
     */
    public static ImageIcon getImageJSplashscreen() {
        return IconFactory.getIcon(IMAGEJ_SPLASHSCREEN);
    }
     ...
     * @return See above.
     */
    public static ImageIcon getOMEIcon() {
        return IconFactory.getIcon(OME_ICON);
    }
    ...
    public ImageIcon getIcon(String name) {
        ImageIcon icon = IconFactory.getIcon(name);
        if (icon == null) {
            StringBuffer buf = new StringBuffer("Failed to retrieve icon: ");
            buf.append("<classpath>");
            buf.append(IconFactory.getResourcePathname(name));
            buf.append(".");
        }
        return icon;
    }
