	...
	extends BasicSliderUI
{
	...
	private void loadThumbArrowImage()
	{
		...
		ImageIcon img = icons.getIcon(IconManager.THUMB);
		thumbWidth = img.getIconWidth();
		thumbHeight = img.getIconHeight();
		thumbImage = img.getImage();
		img = icons.getIcon(IconManager.THUMB_DISABLED);
		disabledThumbImage = img.getImage();

		img = icons.getIcon(IconManager.UP_ARROW_DISABLED_10);
		...
		img = icons.getIcon(IconManager.DOWN_ARROW_DISABLED_10);
		downArrowDisabledImage = img.getImage();
		img = icons.getIcon(IconManager.LEFT_ARROW_DISABLED_10);
		leftArrowDisabledImage = img.getImage();
		img = icons.getIcon(IconManager.RIGHT_ARROW_DISABLED_10);
		rightArrowDisabledImage = img.getImage();
		img = icons.getIcon(IconManager.UP_ARROW_10);
		upArrowImage = img.getImage();
		img = icons.getIcon(IconManager.DOWN_ARROW_10);
		downArrowImage = img.getImage();
		img = icons.getIcon(IconManager.LEFT_ARROW_10);
		leftArrowImage = img.getImage();
		img = icons.getIcon(IconManager.RIGHT_ARROW_10);
