...
class TwoKnobsSliderUI
{
	...
	private void createThumbImage()
	{
		...
		ImageIcon icon = icons.getIcon(IconManager.THUMB);
		thumbImage = icon.getImage();
		icon = icons.getIcon(IconManager.THUMB_DISABLED);
		disabledThumbImage = icon.getImage();
		icon = icons.getIcon(IconManager.UP_ARROW_10);
		upArrowImage = icon.getImage();
		icon = icons.getIcon(IconManager.UP_ARROW_DISABLED_10);
