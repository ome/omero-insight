    ...
    PropertyChangeListener
{
    ...
    private void initComponents()
    {
        ...
        gridRatioSlider.setArrowsImageIcon(
        				icons.getIcon(IconManager.RATIO_MAX),
        				icons.getIcon(IconManager.RATIO_MIN));
        ...
        ratioSlider.setArrowsImageIcon(
        		icons.getIcon(IconManager.RATIO_MAX),
        		icons.getIcon(IconManager.RATIO_MIN),
        		icons.getIcon(IconManager.RATIO_MAX_DISABLED),
        		icons.getIcon(IconManager.RATIO_MIN_DISABLED));
        resetZoom = new JButton(icons.getIcon(IconManager.ZOOM_FIT));
