 ...
 * {@link #getIcon(int) getImageIcon} method passing one of the icon ID's specified
...
public class IconManager extends AbstractIconManager {
     ...
     */
    private static final String SPLASH_SCREEN = "client_splashscreen.png";

    /**
     * The pathname, relative to this class, of the editor splash screen.
     */
    private static final String SPLASH_SCREEN_IMPORTER = "importer_splashscreen.png";

    /**
     * The pathname, relative to this class, of the login splash screen.
     */
    private static final String LOGIN_BACKGROUND = "login_background.png";

    /**
     * The pathname, relative to this class, of the config logo.
     */
    private static final String SPLASH_SCREEN_CONFIG_LOGO = "nuvola_configure48.png";

    /**
     * The pathname, relative to this class, of the splash screen config button
     * image.
     */
    private static final String SPLASH_SCREEN_CONFIG = "config.png";

    /**
     * The pathname, relative to this class, of the splash screen config button
     * image when pressed.
     */
    private static final String SPLASH_SCREEN_CONFIG_PRESSED = "config_pressed.png";

    /**
     * The pathname, relative to this class, of the server icon.
     */
    private static final String SERVER_LOGO = "nuvola_server22.png";

    /**
     * The pathname, relative to this class, of the arrow right icon.
     */
    private static final String ARROW_RIGHT = "nuvola_1rightarrow16.png";

    /**
     * The pathname, relative to this class, of the arrow down icon.
     */
    private static final String ARROW_DOWN = "nuvola_1downarrow16.png";

    /**
     * The pathname, relative to this class, of the minus icon.
     */
    private static final String MINUS = "nuvola_edit_remove16.png";

    /**
     * The pathname, relative to this class, of the default error icon to
     * use for notification dialogs.
     */
    private static final String DEFAULT_ERROR_ICON_PATH = "nuvola_filetypes32.png";

    /**
     * The pathname, relative to this class, of the default warning icon to
     * use for notification dialogs.
     */
    private static final String DEFAULT_WARN_ICON_PATH = "nuvola_messagebox_warning32.png";

    /**
     * The pathname, relative to this class, of the default info icon to
     * use for notification dialogs.
     */
    private static final String DEFAULT_INFO_ICON_PATH = "nuvola_messagebox_info32.png";

    /**
     * The pathname, relative to this class, of the default close icon to
     * use for tiny window dialogs.
     */
    private static final String DEFAULT_CLOSE_PATH = "cross.png";

    /**
     * The pathname, relative to this class, of the default close icon to
     * use for tiny window dialogs.
     */
    private static final String DEFAULT_CLOSE_OVER_PATH = "cross_over.png";

    /**
     * The pathname, relative to this class, of the default minus icon to
     * use for tiny window dialogs.
     */
    private static final String DEFAULT_MINUS_PATH = "minus.png";

    /**
     * The pathname, relative to this class, of the default minus_over icon to
     * use for tiny window dialogs.
     */
    private static final String DEFAULT_MINUS_OVER_PATH = "minus_over.png";

    /**
     * The pathname, relative to this class, of the default plus icon to
     * use for tiny window dialogs.
     */
    private static final String DEFAULT_PLUS_PATH = "plus.png";

    /**
     * The pathname, relative to this class, of the default plus_over icon to
     * use for tiny window dialogs.
     */
    private static final String DEFAULT_PLUS_OVER_PATH = "plus_over.png";

    /**
     * The pathname, relative to this class, of the logo icon to
     * use for the about software dialog.
     */
    private static final String LOGO_ABOUT = "ome64.png";

    /**
     * The pathname, relative to this class, of the upgrade icon.
     */
    private static final String UPGRADE = "ome64.png";

    /**
     * The pathname, relative to this class, of the upgrade icon.
     */
    private static final String RESULTS = "nuvola_kig48.png";
     ...
     * @return See above.
     */
    static Icon getLogoAbout() {
        return createIcon(LOGO_ABOUT);
    }
    ...
    /**
     * Same as {@code AbstractIconManager.createIcon} but with appended based path.
     *
     * @param path
     * @return the specified ImageIcon or null if not found
     */
    protected static ImageIcon createIcon(String path) {
        return AbstractIconManager.createIcon("/images/env/" + path);
    }
}
